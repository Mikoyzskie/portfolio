            ...
            <div className="max-w-[1440px] w-full m-auto relative px-[32px]">
                <div className='max-w-[1110px] w-full m-auto grid md:grid-cols-2 grid-cols-1 gap-12 md:gap-[220px] '>
                    ...
                    <div className='flex flex-col gap-8 items-end'>
                        <input type="text" className='required:border-[#FF6F5B] in valid:border-[#4EE1A0] focus:border-[#4EE1A0] w-full bg-transparent outline-none border-b tracking-[-0.22px] text-base font-medium leading-[26px] pb-[17px] uppercase' placeholder='NAME' required />
                        <div className="w-full text-right relative">
                            <input type="email" className='w-full bg-transparent outline-none border-b tracking-[-0.22px] text-base font-medium leading-[26px] pb-[17px] invalid:border-[#FF6F5B] peer' placeholder='EMAIL' />
